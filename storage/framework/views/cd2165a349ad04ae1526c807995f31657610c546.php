<form id="containerForm" class="form app-lb-ajax-form bv-form" data-multipart="true" enctype="multipart/form-data"
      action="<?php echo e(url('/')); ?>/admin/playlist/store" method="post" novalidate="novalidate">
    <?php echo csrf_field(); ?>
                ...
                <div class="col-md-9 col-sm-8">
                    <div class="row">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <div class="col-md-9">
                                <select value="" class="form-control select2" id="category_id" name="category_id">
                                    <?php if($categories): ?>
...
<?php /**PATH C:\xampp\htdocs\tbn24\resources\views/admin/playlist/create.blade.php ENDPATH**/ ?>