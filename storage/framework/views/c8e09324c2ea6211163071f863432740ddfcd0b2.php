        ...
        <div class="profile">
            <div class="row">
                <div class="col-sm-3 account-sidebar">
                    <div class="innerbox">
                        <div class="coverphoto"><img class="avatar" src="https://www.village-bd.com/images/avtar.jpg">
                            <div class="name">isolutions</div>
                        </div>
                        <ul class="nav">
                            <li><a href="<?php echo e(url('/')); ?>/myaccount">  My Profile </a></li>

                            <li><a href="?page=changepw">  Change
                                    Password </a></li>
                            <li> <a href="?page=changephoto">  Change Photo </a> </li>
