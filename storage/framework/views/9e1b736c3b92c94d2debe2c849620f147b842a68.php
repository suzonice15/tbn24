...
<form id="containerForm" class="form app-lb-ajax-form bv-form" data-multipart="true" enctype="multipart/form-data" action="<?php echo e(url('admin/news/update')); ?>/<?php echo e($new->news_id); ?>" method="post" novalidate="novalidate">
    <?php echo csrf_field(); ?>
    <div class="row ">
            ...
            <div class="row">
                <div class="col-md-10 col-sm-8">
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <div class="col-md-9">
                            <input type="text" maxlength="150" value="<?php echo e($new->news_title); ?>" class="form-control" id="news_title" name="news_title" placeholder="Title"  >
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <div class="col-md-9">
                            <textarea type="text" maxlength="255" class="form-control" id="news_body" name="news_body" placeholder="Full News" ><?php echo e($new->news_body); ?></textarea>
...
<?php /**PATH C:\xampp\htdocs\tbn24\resources\views/admin/news/edit.blade.php ENDPATH**/ ?>