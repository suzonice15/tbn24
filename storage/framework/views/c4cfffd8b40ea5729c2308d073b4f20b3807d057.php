    ...
    <div class="box-body">
        ...
        <div class="table-responsive">
            ...
            <table class="table table-bordered table-striped   ">
                ...
                <?php echo $__env->make('admin.schedule.pagination_schedule_weekly', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </tbody>
            ...
            $(document).ready(function () {
                ...
                $(document).on('click', '#search', function () {
                    ...
                    if(data_id=='day'){
                        $.ajax({
                            type: "GET",
                            url: "<?php echo e(url('schedules/fetch_data_using_week')); ?>?day_id=" + day_id,
                            success: function (data) {
                                $('tbody').html('');
                                $('tbody').html(data);
                            }
                        ...
                        $.ajax({
                            type: "GET",
                            url: "<?php echo e(url('schedules/fetch_data_using_program_week')); ?>?program_id=" + program_id,
                            success: function (data) {
                                $('tbody').html('');
                                $('tbody').html(data);
                            }
                ...
                $('#add_modal').click(function () {
                    $.ajax({
                        type: "GET",
                        url: "<?php echo e(url('admin/schedule-weekly/create')); ?>",
                        success: function (data) {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tbn24\resources\views/admin/schedule/schedule_weekly.blade.php ENDPATH**/ ?>