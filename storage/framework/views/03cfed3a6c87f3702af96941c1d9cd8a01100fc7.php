    ...
    <div class="table-responsive">
        ...
        <table  class="table table-bordered table-striped   ">
            ...
            <tbody>
               ...
               <?php echo $__env->make('admin.faq.pagination', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </tbody>
...
<script>
    $(document).ready(function(){
        ...
        function fetch_data(page, query)
        {
          $.ajax({
                type:"GET",
                url:"<?php echo e(url('faq/pagination')); ?>?page="+page+"&query="+query,
...
$('#add_modal').click(function () {
    $.ajax({
        type:"GET",
        url:"<?php echo e(url('admin/faq/create')); ?>",
        success:function(data)
        {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tbn24\resources\views/admin/faq/index.blade.php ENDPATH**/ ?>