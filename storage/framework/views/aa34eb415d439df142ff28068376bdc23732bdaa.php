...
<form id="containerForm" class="form app-lb-ajax-form bv-form" data-multipart="true" enctype="multipart/form-data" action="<?php echo e(url('/')); ?>/admin/popular/video/store" method="post" novalidate="novalidate">
    <?php echo csrf_field(); ?>
    <div class="row ">
            ...
            <div class="row">
                <div class="col-md-10 col-sm-8">
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <div class="col-md-9">
                            <input required type="text" maxlength="255" class="form-control" id="order_by" name="order_by" placeholder="order by" >
...
<?php /**PATH C:\xampp\htdocs\tbn24\resources\views/admin/popularvideo/create.blade.php ENDPATH**/ ?>