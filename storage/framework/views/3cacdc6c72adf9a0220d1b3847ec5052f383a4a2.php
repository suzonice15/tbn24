...
<form id="containerForm" class="form app-lb-ajax-form bv-form" data-multipart="true" enctype="multipart/form-data" action="<?php echo e(url('admin/playlist/update')); ?>/<?php echo e($playlist->playlist_id); ?>" method="post" novalidate="novalidate">
    <?php echo csrf_field(); ?>
...
<script type="text/javascript">
    ...
    document.forms['containerForm'].elements['category_id'].value = "<?php echo e($playlist->category_id); ?>";
...
<?php /**PATH C:\xampp\htdocs\tbn24\resources\views/admin/playlist/edit.blade.php ENDPATH**/ ?>