...
<div class="box-body">
    <div class="row">
        <div class="col-md-6">
            <button type="button" class="btn btn-xs btn-success" data-toggle="modal" id="add_modal" data-target="#add-schedule">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tbn244\resources\views/admin/schedule/index.blade.php ENDPATH**/ ?>