...
<?php $__env->startSection('mainContent'); ?>
    ...
    <div class="box-body">
        ...
        <div class="box box-success" style="border: 2px solid #ddd;">
            <div class="box-header" style="background-color: #ddd;color:blac">
            ...
            <div class="box-body" style="padding: 26px;">
                <div class="form-group ">
                    ...
                    <select name="app_time_zone" id="app_time_zone" class="form-control select2">
                ...
                <div class="form-group ">
                    ...
                    <select name="program_start_type" id="program_start_type" class="form-control select2">
            ...
            <div class="col-md-6 col-xs-12">
                ...
                <div class="box box-success" style="border: 2px solid #ddd;">
                    <div class="box-header" style="background-color: #ddd;color:black">
                        <h3 class="box-title">Social Setting</h3>
                    </div>
