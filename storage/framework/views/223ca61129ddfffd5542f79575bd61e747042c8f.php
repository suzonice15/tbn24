...
<form id="containerForm" class="form app-lb-ajax-form bv-form" data-multipart="true" enctype="multipart/form-data" action="<?php echo e(url('/')); ?>/admin/programs/store" method="post" novalidate="novalidate">
    <?php echo csrf_field(); ?>
    <div class="row ">
            ...
            <div class="row">
                <div class="col-md-10 col-sm-8">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <div class="col-md-9">
                                <textarea type="text" maxlength="255" class="form-control" id="program_details" name="program_details" placeholder="Details" ></textarea>
                            ...
                            <div id="select_image" class="panel panel-default">
                                <div id="imageUploaderContainer" class="panel-body p-5" style="overflow: hidden; position: relative; height: 30.117px;">
                                    ...
                                    <div class="img-container" style="position: absolute; overflow: hidden; left: 5px; right: 5px; top: 5px; bottom: 5px;">
                                        <img class="image-display " style="display:none;  height: 50%">
                                    </div>
...
<?php /**PATH C:\xampp\htdocs\tbn244\resources\views/admin/program/create.blade.php ENDPATH**/ ?>