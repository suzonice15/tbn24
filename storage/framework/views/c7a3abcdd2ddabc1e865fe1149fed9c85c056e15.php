...
<div class="box-body">
    <div class="row">
        ...
        <div class="col-md-4  pull-right">
            <input type="text" id="serach" name="search" placeholder="Enter Program Name" class="form-control" >
        </div>
    </div>
    <br/>
    <div class="table-responsive">
        ...
        <table  class="table table-bordered table-striped   ">
            ...
            <tbody>
               ...
               <?php echo $__env->make('admin.program.pagination', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </tbody>
...
<script>
    $(document).ready(function(){
        ...
        function fetch_data(page, query)
        {
          $.ajax({
                type:"GET",
                url:"<?php echo e(url('program/pagination')); ?>?page="+page+"&query="+query,
...
$('#add_modal').click(function () {
    $.ajax({
        type:"GET",
        url:"<?php echo e(url('admin/programs/create')); ?>",
        success:function(data)
        {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tbn244\resources\views/admin/program/index.blade.php ENDPATH**/ ?>