    ...
    <section id="works" class="works">
        <div class="container">
            ...
            <div class="row">
                ...
                <?php if($videoLists): ?>
                    <?php $__currentLoopData = $videoLists['results']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $videoList): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-sm-4 col-xs-12">
                            <figure class="wow fadeInLeft animated portfolio-item animated">
                                <div class="img-wrapper">
                                    ...
                                    <div class="overlay">
                                        <div class="buttons">
                                            <a  target="_blank" data-youtube-id="<?php echo e($videoList->snippet->resourceId->videoId); ?>"
                                                class="video-banner js-trigger-video-modal"
                                                href="http://www.youtube.com/watch?v=<?php echo e($videoList->snippet->resourceId->videoId); ?>">Play
                                                Video</a>
                                        </div>
                                    </div>
                                </div>
                                <figcaption>
                                    <h4>
                                        <a    data-youtube-id="<?php echo e($videoList->snippet->resourceId->videoId); ?>"
                                              class="video-banner js-trigger-video-modal"  target="_blank"
                                              href="http://www.youtube.com/watch?v=<?php echo e($videoList->snippet->resourceId->videoId); ?>"> <?php echo e($videoList->snippet->title); ?></a>
                                    </h4>
                                </figcaption>
                            </figure>
                        </div>
...
<?php echo $__env->make('website.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tbn24\resources\views/website/youtubePlaylist.blade.php ENDPATH**/ ?>