...
<form class="form"  id="containerForm" action="<?php echo e(url('/')); ?>/admin/schedules/store"
      method="post">
    <?php echo csrf_field(); ?>
    <div class="row ">
        <div class="col-md-11">
        ...
        <div class="clearfix form-horizontal">
            ...
            <div class="form-group has-feedback">
                ...
                <div class="col-md-9">
                    <input type="text" maxlength="" value="" class="form-control datepicker" id="schedule_date"
...
<?php /**PATH C:\xampp\htdocs\tbn244\resources\views/admin/schedule/create.blade.php ENDPATH**/ ?>