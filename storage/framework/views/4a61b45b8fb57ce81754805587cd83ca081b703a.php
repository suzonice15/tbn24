...
<form id="containerForm" class="form app-lb-ajax-form bv-form" data-multipart="true" enctype="multipart/form-data" action="<?php echo e(url('admin/programs/update')); ?>/<?php echo e($program->id); ?>" method="post" novalidate="novalidate">
    <?php echo csrf_field(); ?>
    <div class="row ">
                                ...
                                <div id="select_image" class="panel panel-default">
                                    <div id="imageUploaderContainer" class="panel-body p-5" style="overflow: hidden; position: relative; height: 30.117px;">
                                        ...
                                        <div class="img-container" style="position: absolute; overflow: hidden; left: 5px; right: 5px; top: 5px; bottom: 5px;">
                                            <img class="image-display" src="<?php echo e(url('/')); ?>/public/uploads/program/<?php echo e($program->program_image); ?>" style="height: 50%">
                                        </div>
...
<?php /**PATH C:\xampp\htdocs\tbn244\resources\views/admin/program/edit.blade.php ENDPATH**/ ?>