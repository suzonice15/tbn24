    ...
    <div class="table-responsive">
        ...
        <table  class="table table-bordered table-striped   ">
            ...
            <tbody>
               ...
               @include('admin.popularvideo.pagination')
            </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" style="text-align:center">Add New Popular Video</h4>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true" style="font-weight: bold">&times;</span></button>
                    <h4 class="modal-title" style="text-align:center">Edit Popular Video</h4>
                </div>
...
<script>
    $(document).ready(function(){
        ...
        function fetch_data(page, query)
        {
          $.ajax({
                type:"GET",
                url:"{{url('admin/popular_video/pagination')}}?page="+page+"&query="+query,
...
$('#add_modal').click(function () {
    $.ajax({
        type:"GET",
        url:"{{url('/admin/popular/video/create')}}",
        success:function(data)
        {
