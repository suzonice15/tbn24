...
<form id="containerForm" class="form app-lb-ajax-form bv-form" data-multipart="true" enctype="multipart/form-data" action="{{ url('/admin/popular/video') }}/{{ $video->id }}" method="post" novalidate="novalidate">
    @csrf
    <div class="row ">
            ...
            <div class="row">
                <div class="col-md-10 col-sm-8">
                    <div class="form-group has-feedback">
                        ...
                        <div class="col-md-9">
                            <input required type="text" maxlength="150" value="{{$video->video_name}}" class="form-control" id="video_name" name="video_name" placeholder="Title"  >
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <div class="col-md-9">
                            <input required type="text" value="{{$video->video_id}}" maxlength="255" class="form-control" id="video_id" name="video_id" placeholder="Youtube Video Id" >
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <div class="col-md-9">
                            <input required type="number" value="{{$video->order_by}}" class="form-control" id="order_by" name="order_by" placeholder="order by" >
