...
<form id="containerForm" class="form app-lb-ajax-form bv-form" data-multipart="true" enctype="multipart/form-data" action="{{ url('admin/faq/update') }}/{{ $faq->faq_id }}" method="post" novalidate="novalidate">
    @csrf
    <div class="row ">
            ...
            <div class="row">
                <div class="col-md-10 col-sm-8">
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <div class="col-md-9">
                            <input type="text" maxlength="150" value="{{$faq->questions}}" class="form-control" id="questions" name="questions" placeholder="Question"  >
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <div class="col-md-9">
                            <textarea type="text" maxlength="255" class="form-control" id="answers" name="answers" placeholder="Answer" >{{$faq->answers}}</textarea>
