@if(isset($products))
    ...
    @foreach ($products as $product)
        <tr>
            ...
            <td>
                <a title="edit" href="{{ url('admin/programs') }}/{{ $product->product_id }}">
                    <span class="glyphicon glyphicon-edit btn btn-success"></span>
                </a>
                <a title="update"  class="btn btn-success" href="{{ url('admin/product/update') }}/{{ $product->product_id }}" >
                    Update
                </a>

                <a title="delete" href="{{ url('admin/programs/delete') }}/{{ $product->product_id }}" onclick="return confirm('Are you want to delete this Product')">
