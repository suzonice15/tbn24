...
<form id="containerForm" class="form app-lb-ajax-form bv-form" data-multipart="true" enctype="multipart/form-data" action="{{ url('admin/replay/comment/update/') }}/{{ $comment->sub_commets_id }}" method="post" novalidate="novalidate">
    @csrf
