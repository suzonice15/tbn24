                    ...
                    <div class="col-sm-3 col-xs-12">
                        <figure class="wow  portfolio-item " >
                            <div class="img-wrapper">
                                <img src="{{$play_list_row->snippet->thumbnails->high->url}}" class="img-responsive" alt="{{$play_list_row->snippet->title}}" width="100%">
                                <div class="overlay">
                                    <div class="buttons">
                                        <a href="{{url('/')}}/youtube-playlist/{{$play_list_row->id}}">Details</a>
                                    </div>
                                </div>
                            </div>
                            <figcaption>
                                <h4>
                                    <a href="{{url('/')}}/youtube-playlist/{{$play_list_row->id}}">{{$play_list_row->snippet->title}}</a>
                                </h4>
                            </figcaption>
                        </figure>
                    </div>
